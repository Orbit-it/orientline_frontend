...
import CarouselImageEseac from '../components/CarouselImageEseac';
        ...
        <View style={styles.middle}>
            ...
            source={require("../assets/eseac_logo.jpg")}
             ...
             <View style={styles.in_middle}>
                <Text style={styles.title} >ESEAC Sfax</Text>
             </View>
             <TouchableOpacity 
                    style={[styles.bref]}
                    onPress={()=>{navigation.navigate(routes.INSESEAC)}}>
